<%@page import="java.util.ArrayList" %>
	<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
		...
		<head>
			...
			<% String monthSales=(String) request.getAttribute("monthSales"); String warningstock=(String)
				request.getAttribute("warningstock"); %>
						...
						<div class="col-xl-3 col-md-6 mb-4">
							<div class="card border-left-info shadow h-100 py-2">
								<div class="card-body" onclick="redirectToURL('adminSearchorders')">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs font-weight-bold text-info text-uppercase mb-1">남은
												주문 처리 비율</div>
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
